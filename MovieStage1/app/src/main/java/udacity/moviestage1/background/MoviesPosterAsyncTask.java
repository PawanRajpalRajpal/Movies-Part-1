package udacity.moviestage1.background;
...
public class MoviesPosterAsyncTask extends AsyncTask<String,Void,ArrayList<MoviesData>> {
    ...
    protected ArrayList<MoviesData> doInBackground(String... params) {
        ...
        try {
            ...
            System.out.println("Moviees aUrl is**********/"+finalUri.toString());
            ...
            System.out.println("String return is************/"+stringBuffer.toString());
